        ...
        self.check_package(
            {
                ...
                'links': [
                    ...
                    (LinkType.PACKAGE_SOURCES, 'https://gitweb.gentoo.org/repo/gentoo.git/tree/games-action/chromium-bsu'),
        ...
        self.check_package(
            {
                ...
                'links': [
                    ...
                    (LinkType.PACKAGE_SOURCES, 'https://gitweb.gentoo.org/repo/gentoo.git/tree/app-misc/asciinema'),
        ...
        self.check_package(
            {
                ...
                'links': [
                    ...
                    (LinkType.PACKAGE_SOURCES, 'https://gitweb.gentoo.org/repo/gentoo.git/tree/app-misc/away'),
        ...
        self.check_package(
            {
                ...
                'links': [
                    ...
                    (LinkType.PACKAGE_SOURCES, 'https://gitweb.gentoo.org/repo/gentoo.git/tree/app-test/aspell'),
        ...
        self.check_package(
            {
                ...
                'links': [
                    ...
                    (LinkType.PACKAGE_SOURCES, 'https://github.com/gobolinux/Recipes/tree/master/AutoFS/5.0.5'),

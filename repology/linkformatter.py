...
_FILTERS: dict[str, Callable[[str], str]] = {
    ...
    'lib_and_first_letter': lambda x: x.lower()[:4] if x.lower().startswith('lib') else x.lower()[0],
    'lib_or_first_letter': lambda x: 'lib' if x.lower().startswith('lib') else x.lower()[0],
    'py_or_first_letter': lambda x: 'py' if x.lower().startswith('py') else x.lower()[0],

...
class GitFetcher(PersistentDirFetcher):
    _url: str
    _branch: str
    _sparse_checkout: list[str] | None
    _timeout_arg: str
    _depth_arg: str | None

    def __init__(self, url: str, branch: str = 'master', sparse_checkout: list[str] | None = None, fetch_timeout: int = 600, depth: int | None = 1) -> None:
        self._url = url
        self._branch = branch

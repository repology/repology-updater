...
def test_versionclasses_big() -> None:
    check_classify(
        # Reference repo
...
def test_versionclass_single_branch1() -> None:
    check_classify(
...
def test_versionclass_single_branch2() -> None:
    check_classify(
...
def test_versionclass_devel_lower_than_default() -> None:
    check_classify(
...
def test_versionclass_unignored_really_unignored() -> None:
    check_classify(
...
def test_versionclass_unique() -> None:
    check_classify(
...
def test_versionclass_branch_bounds1() -> None:
    check_classify(
        PackageSample(repo='1', version='2.2beta1', flags=Pf.DEVEL).expect(versionclass=Ps.DEVEL),
...
def test_versionclass_branch_bounds2() -> None:
    check_classify(
        PackageSample(repo='1', version='2.2beta1', flags=Pf.DEVEL).expect(versionclass=Ps.DEVEL),
...
def test_versionclass_branch_bounds3() -> None:
    check_classify(
...
def test_versionclass_ignoredignored() -> None:
    check_classify(
...
def test_versionclass_sameversionsamestatus() -> None:
    check_classify(
        PackageSample(repo='2', version='2.2').expect(versionclass=Ps.NEWEST),
...
def test_versionclass_manylegacy() -> None:
    check_classify(
        PackageSample(repo='2', version='2.2').expect(versionclass=Ps.NEWEST),
        # one of these packages should not make the other one legacy instead of outdated
        PackageSample(repo='1', version='2.1').expect(versionclass=Ps.OUTDATED),
...
def test_versionclass_flavors() -> None:
    check_classify(
...
def test_versionclass_outdated() -> None:
    check_classify(
...
def test_versionclass_legacy() -> None:
    check_classify(
        PackageSample(repo='1', version='2.0').expect(versionclass=Ps.NEWEST),
...
def test_versionclass_nolegacy() -> None:
    check_classify(
        PackageSample(repo='1', version='2.0').expect(versionclass=Ps.NEWEST),
...
def test_suppress_ignored() -> None:
    check_classify(
...
def test_suppress_ignored_rolling() -> None:
    check_classify(
...
def test_suppress_ignored_noscheme() -> None:
...
def test_sublimetext_case() -> None:
    check_classify(
